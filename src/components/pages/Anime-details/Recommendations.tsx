  ...
  return (
    <div className='pt-10'>
      ...
      <div className='relative'>
        ...
        <div className='hidden md:block absolute top-0 left-0 w-[60px] h-full bg-gradient-to-r from-black/70'></div>
        <div className='hidden md:block absolute top-0 right-0 w-[60px] h-full bg-gradient-to-l from-black/70'></div>
        <Arrows />
      </div>
    </div>
  )
